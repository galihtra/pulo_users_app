...
import 'package:users_app/global/trip_rider_var.dart';
import 'package:users_app/global/global_var.dart';

import '../../main/auth/auth_page.dart';
import '../../methods/common_methods.dart';
import '../../methods/manage_riders_methods.dart';
...
class _HomePageRiderState extends State<HomePageRider> {
  ...
  List<OnlineNearbyRiders>? availableNearbyOnlineRidersList;
  ...
  makeDriverNearbyCarIcon() {
    if (carIconNearbyDriver == null) {
      ...
      BitmapDescriptor.fromAssetImage(
              configuration, "assets/images/tracking_riders.png")
          .then((iconImage) {
  ...
  updateAvailableNearbyOnlineDriversOnMap() {
    ...
    for (OnlineNearbyRiders eachOnlineNearbyDriver
        in ManageRidersMethods.nearbyOnlineRidersList) {
      LatLng driverCurrentPosition = LatLng(
          eachOnlineNearbyDriver.latRider!, eachOnlineNearbyDriver.lngRider!);

      Marker driverMarker = Marker(
        markerId: MarkerId(
            "rider ID = " + eachOnlineNearbyDriver.uidRider.toString()),
  ...
  initializeGeoFireListener() {
    Geofire.initialize("onlineRiders");
      ...
      if (driverEvent != null) {
        ...
        switch (onlineDriverChild) {
          case Geofire.onKeyEntered:
            OnlineNearbyRiders onlineNearbyRiders = OnlineNearbyRiders();
            onlineNearbyRiders.uidRider = driverEvent["key"];
            onlineNearbyRiders.latRider = driverEvent["latitude"];
            onlineNearbyRiders.lngRider = driverEvent["longitude"];
            ManageRidersMethods.nearbyOnlineRidersList.add(onlineNearbyRiders);
          ...
          case Geofire.onKeyExited:
            ManageRidersMethods.removeRiderFromList(driverEvent["key"]);
          ...
          case Geofire.onKeyMoved:
            ...
            onlineNearbyRiders.latRider = driverEvent["latitude"];
            onlineNearbyRiders.lngRider = driverEvent["longitude"];
            ManageRidersMethods.updateOnlineNearbyRidersLocation(
                onlineNearbyRiders);
  ...
  makeTripRequest() {
    tripRequestRef =
        FirebaseDatabase.instance.ref().child("tripRequestsRider").push();
    ...
    tripStreamSubscription =
      ...
      if ((eventSnapshot.snapshot.value as Map)["driverName"] != null) {
        nameRider = (eventSnapshot.snapshot.value as Map)["driverName"];
      }
      ...
      if ((eventSnapshot.snapshot.value as Map)["driverPhoto"] != null) {
        photoRider = (eventSnapshot.snapshot.value as Map)["driverPhoto"];
      }

      if ((eventSnapshot.snapshot.value as Map)["carDetails"] != null) {
        carDetailsRider = (eventSnapshot.snapshot.value as Map)["carDetails"];
      }
  ...
  searchDriver() {
    if (availableNearbyOnlineRidersList!.length == 0) {
      cancelRideRequest();
      resetAppNow();
      noDriverAvailable();
      return;
    ...
    var currentDriver = availableNearbyOnlineRidersList![0];

    //send notification to this currentDriver - currentDriver means selected driver
    sendNotificationToDriver(currentDriver);

    availableNearbyOnlineRidersList!.removeAt(0);
  }

  sendNotificationToDriver(OnlineNearbyRiders currentRider) {
    //update driver's newTripStatus - assign tripID to current driver
    DatabaseReference currentDriverRef = FirebaseDatabase.instance
        .ref()
        .child("riders")
        .child(currentRider.uidRider.toString())
        .child("newTripStatusRider");
    ...
    tokenOfCurrentDriverRef.once().then((dataSnapshot) {
      ...
      var timerCountDown = Timer.periodic(oneTickPerSec, (timer) {
        requestTimeoutRider = requestTimeoutRider - 1;
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      availableNearbyOnlineRidersList =
                                          ManageRidersMethods
                                              .nearbyOnlineRidersList;
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            launchUrl(Uri.parse("tel://$phoneNumberRider"));
                          },
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
